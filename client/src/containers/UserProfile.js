  ...
  async setData(username) {
    await ApiCall.user
      ...
      .then(res => {
        ...
        ApiCall.user
          .checkUserLikes(this.Auth.getConfirm()["id"], username)
          .then(res => {
            this._isMounted &&
              this.setState({
        ...
        ApiCall.user
          .checkIfTheUserIsReported(this.Auth.getConfirm()["id"], this.state.user.id)
          .then(res => {
            this._isMounted &&
              this.setState({
        ...
        ApiCall.user
          .checkIfTheUserIsBlocked(this.Auth.getConfirm()["id"], this.state.user.id)
          .then(res => {
            this._isMounted &&
              this.setState({
