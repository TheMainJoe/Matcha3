...
class Register extends Component {
    ...
    return (
      <div className="App">
        ...
        {this.state.responseToPost === "success" ? (
          <div className="msg msg-info z-depth-3">Success!</div>
        ) : (
          ""
        )}
        <div className="row login-register-page">
          <div className="col a12 m6" id="login-box">
            <div className="login-header">Register to get that Love</div>
  ...
  getLocation = () => {
    GeoPosition.config({
      ...
      google: {
        version: "3",
        key: "AIzaSyD6m6m4JM1B2tzLcJBnY0pLfw-PB77WoUo",
      },
    });
