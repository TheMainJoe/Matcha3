...
class NavBar extends Component {
  ...
  async componentDidMount() {
    ...
    if (this.state.socket) {
      ...
      this.state.socket.on("messageReadSocket", data => {
        // eslint-disable-next-line
  ...
  render() {
    ...
    const LoggedInLinks = () => {
      ...
      const sideList = (side, listNotif) => (
        ...
        >
          <h5 style={{ textAlign: "center", color: "#00BFA5" }}>
            Notifications
          </h5>
          <List>
            {listNotif.length < 1 ? (
    ...
    const MobileLoggedInLinks = () => {
      ...
      const MobileMenuLogged = menu => (
        ...
        >
          <h5 style={{ textAlign: "center", color: "#00BFA5" }}>Menu</h5>
          <List>
            <ListItem>
        ...
        <nav>
          <div className="nav-wrapper">
            <NavLink to="/" className="brand-logo">
              <h4 className="header-logo">ENTANGLEMENT</h4>
            </NavLink>
            <NavLinks />
          </div>
        </nav>
