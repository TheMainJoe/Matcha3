...
class UserCard extends Component {
  ...
  async componentDidMount() {
    ...
    ApiCall.user
      .checkUserLikes(this.props.uid, this.props.intel.username)
      .then(res => {
        this._isMounted &&
          this.setState({
  ...
  handleLike = () => {
    ...
    ApiCall.user.executeUserLike(this.props.intel.id, this.props.uid);
  ...
  handleDislike = () => {
    ...
    ApiCall.user.removeUserLikes(this.props.intel.id, this.props.uid);
